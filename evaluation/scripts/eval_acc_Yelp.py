...
def main():
    ...
    # assert args.test_aspect is not None
        if args.test_aspect == 'sentiment':
            args.model_name_or_path = './classifiers/Yelp/sentiment'
            args.tar_dim = 2
        elif args.test_aspect == 'pronoun':
            args.model_name_or_path = './classifiers/Yelp/pronoun'
            args.tar_dim = 2
        elif args.test_aspect == 'tense':
            args.model_name_or_path = './classifiers/Yelp/tense'
            args.tar_dim = 2
